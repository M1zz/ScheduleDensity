...
struct TodoWidgetSnapshot: Codable {
    ...
    static let sample = TodoWidgetSnapshot(
        items: [
            Item(id: "1", title: String(localized: "기획서 초안 작성"), colorHex: "#007AFF", categoryName: String(localized: "개발"),
                 isCarryover: false, isToday: true,
                 stepTitle: String(localized: "목차 잡기"), progress: 0.3,
                 stepIndex: 1, stepCount: 4),
            Item(id: "2", title: String(localized: "위젯 스냅샷 정리"), colorHex: "#5856D6", categoryName: String(localized: "개발"),
                 isCarryover: true, isToday: false),
            Item(id: "3", title: String(localized: "장보기 — 우유, 계란"), colorHex: "#34C759", categoryName: String(localized: "집안일"),
                 isCarryover: false, isToday: false, isFragment: true),
            Item(id: "4", title: String(localized: "러닝 30분"), colorHex: "#FF9500", categoryName: String(localized: "운동"),
                 isCarryover: false, isToday: false),
            Item(id: "5", title: String(localized: "책 한 챕터 읽기"), colorHex: nil, categoryName: nil,
                 isCarryover: false, isToday: false),
        ],
        fragments: [
            Fragment(id: "f1", title: String(localized: "자료 링크 하나 챙기기"), parentTitle: String(localized: "기획서 초안 작성"),
                     colorHex: "#007AFF", minutes: 5, isMarked: true),
            Fragment(id: "f2", title: String(localized: "장보기 — 우유, 계란"), parentTitle: nil,
                     colorHex: "#34C759", minutes: 15, isMarked: false),
            Fragment(id: "f3", title: String(localized: "업체 예약 전화"), parentTitle: String(localized: "이사 준비"),
