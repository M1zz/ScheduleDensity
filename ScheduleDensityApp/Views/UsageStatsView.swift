...
struct UsageStatsView: View {
    ...
    private var sharingSection: some View {
        Section {
            ...
            Text("""
                 보내는 것은 이 화면의 **숫자**와, '무지개 Pro' 안내 화면에서 벌어진 일 몇 가지입니다 — 그 화면을 보셨는지, 어느 잠긴 기능에서 들어오셨는지, 사셨는지 못 사셨는지. **전부 앱이 미리 정해 둔 낱말이고, 결제 정보와 영수증은 나가지 않습니다.**
                 할 일 제목도, 일정 이름도, 분류 이름도, 날짜도 나가지 않습니다.
